...
class NadaLoginPage extends StatelessWidget {
  final TextEditingController emailController = TextEditingController();
  final TextEditingController passwordController = TextEditingController();
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  final NadaLoginController _loginController = Get.put(NadaLoginController());
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          Get.snackbar("Forget Password", "Not Ready yey",
